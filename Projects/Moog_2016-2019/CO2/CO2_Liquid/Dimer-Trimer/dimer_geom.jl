...
file_out_COC = open( string( folder_out, "anglesCOC_moleculars_dimer.dat" ), "w" )
file_out_OCO = open( string( folder_out, "anglesOCO_moleculars_dimer.dat" ), "w" )
for ibox = 1:nb_box
...
file_out_COC = open( string( folder_out, "anglesCOC_polymeric_dimer.dat" ), "w" )
file_out_OCO = open( string( folder_out, "anglesOCO_polymeric_dimer.dat" ), "w" )
for ibox = 1:nb_box
    Base.write( file_out_COC, string( ibox*delta_angle + min_angle, " ", anglesCOC[ ibox ], "\n" ) )
    Base.write( file_out_OCO, string( ibox*delta_angle + min_angle, " ", anglesOCO[ ibox ], "\n" ) )
end
...
Volumes=[ 10.0, 9.8, 9.5, 9.4, 9.375, 9.35, 9.3, 9.25, 9.2, 9.15, 9.1, 9.05, 9.0, 8.82, 8.8, 8.6 ]
Temperatures=[ 1750, 2000, 2500, 3000 ]
...
file_out_COC = open( string( folder_out, "anglesCOC_polymeric_all.dat" ), "w" )
file_out_OCO = open( string( folder_out, "anglesOCO_polymeric_all.dat" ), "w" )
for ibox = 1:nb_box
    Base.write( file_out_COC, string( ibox*delta_angle + min_angle, " ", anglesCOC[ ibox ], "\n" ) )
    Base.write( file_out_OCO, string( ibox*delta_angle + min_angle, " ", anglesOCO[ ibox ], "\n" ) )
end
