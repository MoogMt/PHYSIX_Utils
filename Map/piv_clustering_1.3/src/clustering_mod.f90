...
subroutine kmedoids_algorithm(frame2frame,n_steps,n_clusters,cluster_size,cluster_centers,cluster_members,slow)
  ...
  integer,allocatable,dimension(:,:),intent(out)::cluster_members

  integer:: max_cluster_size

!  double precision :: v(n_steps),dl(n_steps)
...
!                                                                                                                        !
!------------------------------------------------------------------------------------------------------------------------!
subroutine daura_algorithm(frame2frame_orig,n_steps,  n_clusters,actual_cluster_size, cluster_centers,actual_cluster_members, cutoff)
  !!!------------------------------------------------------------------------
