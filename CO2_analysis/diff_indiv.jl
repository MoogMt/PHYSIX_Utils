...
file_out=open(string(folder_base,"Block-",V,"-",T,".dat"),"w")
for nb_delta2=1000:1000:15000
    for nb_space=200:200:1000

        print("Progress: ",nb_delta2,"/5000 ",nb_space,"/500\n")
        ...
        write(file_out,string(count_2," ",D_avg," ",D_var," ",nb_delta2," ",nb_space,"\n"))
