    ...
    if molecules.atom_names[atom1] == "C"
        ...
        for atom2=1:nb_atoms
            ...
            if dist < cut_off
                ...
                molecules.atom_names[atom2]=string("O") # Changing name to O1 or O2
                molecules.mol_names[atom2]="CO2"        # Changing molecule name
...
# Writting PDB
#------------------------------------------------
pdb.writeStep(molecules,cell,"/home/moogmt/Pa3_ready.pdb")
#------------------------------------------------

cell_mod.wrap(molecules,cell)

pdb.writeStep(molecules,cell,"/home/moogmt/Pa3_ready_wrapped.pdb")
