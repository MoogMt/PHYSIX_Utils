    ...
    for V in Volumes
        for T in Temperatures
            ...
            for step=1:nb_steps
                ...
                print("Currently at - ",V," - ",T,"-",cut_off," ; progress:",step/nb_steps*100," %\n")
                ...
                for carbon=1:nbC
                    ...
                    for atom=1:nb_atoms
                        if carbon != atom
                            if cell_mod.distance(traj[step],cell,carbon,atom) < cut_off
                                coord_C += 1
                            end
                        end
                    end
                ...
                for oxygen=1:nbO
                    ...
                    for atom=1:nb_atoms
                        if oxygen+nbC != atom
                            if  cell_mod.distance(traj[step],cell,oxygen,atom) < cut_off
                                coord_O += 1
                            end
                        end
                    end
